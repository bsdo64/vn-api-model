    ...
    <tr>
      ...
      <td valign="top" class="specbundle"><div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable">
                                  <p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#10a07b;'><span class="font">베나클 가입을 환영합니다!</span> </p>
                                </div>
                              </div></td>
    </tr>
  </tbody>
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <h2 style="font-family:Georgia,Time,sans-serif;font-size:18px;" >아래 이메일 인증 코드를 입력해주세요</h2>
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p style="font-family:Georgia,Time,sans-serif;">
                                    인증번호 : <strong><span style='color:#222222;'>${code}</span></strong>
                                  </p>
                                </div>
                              </div>
                            </td>
        	...
        	<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <h2 style="font-family:Georgia,Time,sans-serif;font-size:18px;" >아래 임시비밀번호로 로그인하세요</h2>
                                </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td align='left'>
                              <div class="contentEditableContainer contentTextEditable">
                                <div class="contentEditable" align='center'>
                                  <p style="font-family:Georgia,Time,sans-serif;">
                                    임시 비밀번호 : <strong><span style='color:#222222;'>${user.newPassword}</span></strong>
                                  </p>
                                </div>
                              </div>
                            </td>
